...
cd ~/opt/zmk/app
../venv/bin/west build -p -d build/left -b nice_nano_v2 -- -DZMK_CONFIG="$(realpath ../../zmk-chocofi/config)" -DSHIELD=corne_left
...
../venv/bin/west build -p -d build/right -b nice_nano_v2 -- -DZMK_CONFIG="$(realpath ../../zmk-chocofi/config)" -DSHIELD=corne_right
